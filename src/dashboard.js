	...
	<div id="dashboard" style="display:none">
		...
		<div class="chart-row cols-2">
			<div class="card" title="List of most consistently active countries over the last 30 days.">
				<div class="chart-title" id="leaderboard-title">
				...
				<div class="chart-wrap" style="height:340px; overflow-y: auto; margin-top: 1rem;" tabindex="0" role="region" aria-labelledby="leaderboard-title">
