...
export default {
	async fetch(request, env, ctx) {
		try {
			...
			// If URL parsing fails, SECURITY_HEADERS might not be defined in this scope, so we retrieve the fallback
			const safeHeaders = getSecurityContext(false).SECURITY_HEADERS;
